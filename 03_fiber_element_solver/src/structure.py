...
class Frame():
    ...
    def assemble(self):
        ...
        self.Residual = self.resisting_forces
    ...
    def getSystemMatrices(self, displacement_increment, lambda_factor_increment):
        ...
        self.displacements = self.displacements_increment + self.displacements_converged
        self.lambda_factor = self.lambda_factor_increment + self.lambda_factor_converged
        #___ Step 5 - 13 ___
        for i, beam_element in enumerate(self.beam_elements):
            print("         Beam Element ", i)
